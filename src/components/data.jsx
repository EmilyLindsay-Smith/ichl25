export const data = [
    ...
    {id: 325, type: 'talk', day: 'tuesday', time: '1415', room: 'L6', author: ['Muriel Norde'], title:'Hapaxes in word formation: heralds or happenstance?', workshop: ''},
    ...
    {id: 294, type: 'talk', day: 'monday', time: '1415', room: 'L2', author: ['Marieke Meelen', 'Ian Roberts'], title:'Extending Parametric Comparison: A Preliminary Investigation of Celtic', workshop: ''},
...
//    {id: 109, type: 'talk', day: 'monday', time: '1415', room: 'L1', author: ['Lea Schäfer', 'Edgar Baumgärtner', 'Marc Brode'], title:'Structure of a middle voice in Germanic high contact varieties', workshop: ''},
    {id: 279, type: 'talk', day: 'monday', time: '1445', room: 'L2', author: ['Krishnan Ram-Prasad'], title:'Past and Non-Past: Parametric diachrony in the tense and aspect systems of ancient Indo-European languages', workshop: ''},
    ...
    {id: 298, type: 'talk', day: 'monday', time: '1345', room: 'L2', author: ['Ian Roberts', 'James Baker', 'Marieke Meelen', 'Krishnan Ram-Prasad'], title:'Extending Parametric Comparison: Some Preliminary Results on Older Indo-European Languages', workshop: ''},
...
//  {id: 166, type: 'talk', day: 'tuesday', time: '1715', room: 'C6', author: ['Jac Conradie'], title:'The Afrikaans auxiliary het ‘have’ from clitic to desinence', workshop: '3'},
    ...
    {id: 194, type: 'talk', day: 'tuesday', time: '1345', room: 'TC', author: ['Quentin Atkinson'], title:'Tongues, trees and Bayesian Inference: towards a global phylogeny of the world’s languages', workshop: '7'},
    ...
    {id: 243, type: 'talk', day: 'tuesday', time: '1445', room: 'TC', author: ['Annemarie Verkerk','Hannah Haynie','Simon Greenhill','Olena Shcherbakova','Hedvig Skirgård','The Grambank Consortium'], title:'A global phylogenetic test of over 150 putative typological universals', workshop: '7'},
    ...
    {id: 357, type: 'talk', day: 'wednesday', time: '1200', room: 'C4', author: ['Tomaz Potocnik'], title:'How to say yes in Latin: Evidence from of Plautus and Terence', workshop: ''},
    ...
    {id: 221, type: 'talk', day: 'wednesday', time: '1230', room: 'C4', author: ['Louise S. Friis'], title:'Voice and valency alternation in some inherited Tocharian verbs', workshop: ''},
...
//    {id: 141, type: 'talk', day: 'thursday', time: '1130', room: 'L2', author: ['Anke Lensch'], title:'English suffixhood revisited: A construction morphology approach to the growing complexity of bases', workshop: ''},
    ...
    {id: 107, type: 'talk', day: 'thursday', time: '1345', room: 'L6', author: ['Gerd Carling','Marc Allassonière-Tang','Raphaëlle Chaix'], title:'Inheritability and transmissibility of linguistic and other cultural features: The coevolution of noun categorization and kinship systems', workshop: ''},
    ...
    {id: 170, type: 'talk', day: 'thursday', time: '1415', room: 'L6', author: ['Frederik Hartmann'], title:'An agent-based modelling approach to wave-like diversification of language families', workshop: ''},
//    {id: 330, type: 'talk', day: 'thursday', time: '1415', room: 'C1', author: ['David Fertig'], title:'Re-examining the interaction of sound-change and analogy from an implicational word-and-paradigm perspective', workshop: ''},
    ...
    {id: 266, type: 'talk', day: 'thursday', time: '1445', room: 'L6', author: ['John Huisman','Bonnie McLean','Chieh-Hsi Wu','Tiago Tresoldi'], title:'Using sound correspondences in Bayesian phylolinguistics: a case study on Japonic', workshop: ''},
...
//    {id: 138, type: 'talk', day: 'friday', time: '1030', room: 'C1', author: ['Stefania Degaetano-Ortlieb','Elke Teich'], title:'Towards a communicative explanation of diachronic language change: an information-theoretic approach', workshop: ''},
    ...
    {id: 129, type: 'talk', day: 'friday', time: '1130', room: 'L1', author: ['Martin Balo','Zuzana Bodnárová'], title:'Gender reduction in contact: the case of Romani in 19th century Hungary', workshop: ''},
    {id: 328, type: 'talk', day: 'friday', time: '1130', room: 'L2', author: ['Nikolaos Lavidas','Vassilis Symeonidis'], title:'The development of linguistic complexity: Evidence from the diachrony of Future periphrases in English and beyond', workshop: ''},
    {id: 157, type: 'talk', day: 'friday', time: '1130', room: 'L3', author: ['Guglielmo Inglese','Anne Wolfsgruber'], title:'Morphological reciprocals from Old to Classical French: a diachronic study of entre-', workshop: ''},
    {id: 13, type: 'talk', day: 'friday', time: '1130', room: 'L6', author: ['Yael Reshef'], title:'A change process never completed: Two unconventional causal conjunctions in Emergent Modern Hebrew', workshop: ''},
    {id: 296, type: 'talk', day: 'friday', time: '1130', room: 'C1', author: ['Ranjan Sen'], title:'Resurrecting rhymes, reasons and (no) rhotics: reconstructing Keats’ pronunciation', workshop: ''},
    {id: 184, type: 'talk', day: 'friday', time: '1130', room: 'C4', author: ['Irene Boehm','Nikolaus Ritt'], title:'An Iterated Learning Experiment of Morphonotactic Consonant Clusters', workshop: ''},
    {id: 128, type: 'talk', day: 'friday', time: '1130', room: 'C6', author: ['Benedikt Peschl','Francesco Barchi'], title:'Preterite Formations in Niya Prakrit and Khotanese: A Case of Substratum Interference', workshop: ''},
    {id: 244, type: 'talk', day: 'friday', time: '1200', room: 'L1', author: ['Katrin Hiietam'], title:'Resistance to man-made and contact-induced syntactic change', workshop: ''},
    {id: 335, type: 'talk', day: 'friday', time: '1200', room: 'L2', author: ['Seongha Rhee'], title:'The end is the beginning: The case of polygrammaticalization of kas "edge" in Korean', workshop: ''},
...
//    {id: 55, type: 'talk', day: 'friday', time: '1415', room: 'L6', author: ['Kristin Hagemann','Signe Laake'], title:'Pragmatically induced movement – discourse subordination in Old Spanish and Old Norwegian', workshop: ''},
    ...
    {id: 42, type: 'talk', day: 'friday', time: '1445', room: 'L1', author: ['Josep Alba-Salas'], title:'Rising Ditransitives: Tomarle miedo-Type Collocations in Spanish (1200s-2000s)', workshop: ''},
    {id: 348, type: 'talk', day: 'friday', time: '1445', room: 'L2', author: ['Natalie Korobzow'], title:'Directions of alignment change', workshop: ''},
    {id: 186, type: 'talk', day: 'friday', time: '1445', room: 'L3', author: ['Angela Chira','Simon Greenhill','Mary Walworth'], title:'On the evolution of linguistic disparity', workshop: ''},
//    {id: 291, type: 'talk', day: 'friday', time: '1445', room: 'L6', author: ['Ilia Afanasev','Olga Lyashevskaya','Viacheslav Kozak'], title:'Combining the frequency-based and string similarity metrics for measuring the language distance between non-standardized Italian and Croatian idioms of the 18th century', workshop: ''},
    {id: 346, type: 'talk', day: 'friday', time: '1445', room: 'C1', author: ['Alessandra Serpone'], title:'The Dynamic-Stative Contrast in Early Semitic: a Preliminary Historical Overview', workshop: ''},
    {id: 216, type: 'talk', day: 'friday', time: '1445', room: 'C4', author: ['Howard Jones','Morgan Macleod'], title:'The perfect in Homer: a synchronic functional account', workshop: ''},
    {id: 302, type: 'talk', day: 'friday', time: '1445', room: 'C6', author: ['Sonja Zeman'], title:'Grammar, register, and language change: The two grammaticalization paths of the German pluperfect', workshop: ''},
...
//    {id: 18, type: 'poster', day: 'friday', time: '1515', room: '', author: ['Alvaro Gonzalez Alba'], title:'California Spanish and how language ideologies and sociolinguistic factors shape the language of the south', workshop: ''},
    ...
    {id: 70, type: 'talk', day: 'tuesday', time: '1130', room: 'L2', author: ['Shuan Karim'], title:'Towards a new paradigm in Historical Syntax', workshop: ''},
    ...
    {id: 297, type: 'talk', day: 'friday', time: '1030', room: 'C1', author: ['Katrin Menzel'], title:'Word formation patterns reflecting discipline-specific communicative needs in scientific writing throughout the 20th century', workshop: ''},
//    {id: 331, type: 'poster', day: 'friday', time: '1515', room: '', author: ['Antoine Primerano'], title:'Koineization and language contact in the history of Spanish: An examination of several morphosyntactic changes', workshop: ''},
    {id: 110, type: 'talk', day: 'friday', time: '1230', room: 'C1', author: ['Artur Bartnik, Wojciech Guz'], title:'Syntactic factors and left-dislocation in Old English', workshop: ''},
