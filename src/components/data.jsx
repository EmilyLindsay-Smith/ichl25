...
//    {id: 324, type: 'poster', day: 'monday', time: '1515', room: '', author: ['Hanne Eckhoff','Nilo Pedrazzini'], title:'Parallel data for semantic analyses of ancient languages: Greek conjunct participles', workshop: ''},
    ...
    {id: 0, type: 'Workshop Organiser', day: 'tuesday', time: 'afternoon', room: 'L1', author: ['Michele Bianconi','Robin Meyer'], title:'The Typology of Contact-Induced Changes in Morphosyntax', workshop: '8'},
    {id: 0, type: 'Workshop Organiser', day: 'tuesday', time: 'afternoon', room: 'L2', author: ['Andrés Enrique-Arias','Sarah Thomason'], title:'On contact-induced non-change', workshop: '6'},
    {id: 0, type: 'Workshop Organiser', day: 'tuesday', time: 'afternoon', room: 'L3', author: ['Erich Round'], title:'Ancient languages and Algorithms: Demystifying new methods in historical linguistics', workshop: '2'},
    {id: 0, type: 'Workshop Organiser', day: 'tuesday', time: 'afternoon', room: 'L6', author: ['Hendrik De Smet','Guglielmo Inglese','Malte Rosemeyer'], title:'Acting on actuation: Why here, why now?', workshop: '1'},
    {id: 0, type: 'Workshop Organiser', day: 'tuesday', time: 'afternoon', room: 'C1', author: ['Katalin É. Kiss'], title:'Consequences of the OV-to-VO change on different levels of clause structure', workshop: '4'},
    {id: 0, type: 'Workshop Organiser', day: 'tuesday', time: 'afternoon', room: 'C4', author: ['Theodore Markopoulos','Brian D. Joseph'], title:'Historical Linguistics at school: An ever-pressing need?', workshop: '5'},
    {id: 0, type: 'Workshop Organiser', day: 'tuesday', time: 'afternoon', room: 'C6', author: ['Michael Frotscher','Robert Mailhammer'], title:'Cliticisation in the evolution of bound morphology', workshop: '3'},
...
//  {id: 166, type: 'talk', day: 'tuesday', time: '1715', room: 'C6', author: ['Jac Conradie'], title:'The Afrikaans auxiliary het ‘have’ from clitic to desinence', workshop: '3'},
    ...
    {id: 0, type: 'talk', day: 'tuesday', time: 'afternoon', room: 'TC', author: ['Russell Gray','Gerd Carling'], title:'Workshop Organiser: Recent advances in computational historical linguistics: New methods and results', workshop: '7'},
