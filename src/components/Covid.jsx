...
export default function Covid() {
    ...
    <h1 id="site-top"> Covid Policy</h1>
    ...
    <p> Paper - please note that in order to keep registration costs as low as possible and reduce the conference's carbon footprint, we are not producing printed conference packs. All information and resources will be available on the conference website. We are also discouraging paper handouts for the same reason.</p>
