        ...
        <h1 id="site-top"> Local Information </h1>
         ...
         <div className="row align-items-center my-5">
            ...
            <h3 id="food">Food and Drink</h3>
                ...
                <li> Gardeners Arms, a pub with an excellent fully vegetarian menu at 39 Plantation Road</li>
            ...
            <p>There is a <em>pharmacy</em> in Jericho (Jhoots, Walton Street) and a <em>GP surgery</em> (<a href="https://www.gpjerichotwo.co.uk" rel="noreferrer" target="_blank">The Observatory Medical Practice</a>, 01865 429993). The closest <em>A&E department</em> is in the John Radcliffe hospital in Headington, about 15 mins drive from the Andrew Wiles Building.</p>
