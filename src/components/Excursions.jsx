...
function Excursions(){
    ...
    <h4>Organised Wednesday Afternoon Trip</h4>
        <p>There is plenty to do within Oxford city itself.</p>
        <p> If there is sufficient interest, we will organise a coach for a trip to Blenheim Palace - more details to follow soon. </p>

    <h4>Organised Saturday Trips</h4>
        <p> If there is sufficient interest, we will organise a coach for a trip to <a href="https://www.themappamundi" target="_blank" rel="noreferrer noopener">Mappa Mundi at Hereford Cathedral</a> and <a href="https://bletchleypark.org.uk/" target="_blank" rel="noreferrer noopener">Bletchley Park</a> - more details to follow soon. </p>
        <p>The Mappa Mundi at Hereford Cathedral dates from the early 14th Century. The Cathedral also features a historic library with texts dating back to the early 9th Century.</p>
        <p>Bletchley Park was home to Alan Turing's codebreaking team that decoded the Enigma Machine during World War II. </p>
